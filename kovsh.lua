...
local directIni = 'visualkovsh.ini'
...
function main()
    ...
    sampRegisterChatCommand('kovsh', function()
        active = not active
        sampAddChatMessage('{#ff3838}Чит - Ковш (cred Cerber USGR): {FFFFFF}'..(active and 'ON' or 'OFF'), -1)
